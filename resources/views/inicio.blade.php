...
<head>
    ...
    <!--scss-->
    <link rel="stylesheet/less" type="text/css" href="{{asset('assets/css/ahava.sass')}}" />
    ...
    <!--favicon-->
    <link rel="icon" href="{{asset('assets/img/icons/ahava.ico')}}">
    <!--materialize-->
...
<body>
    <div id="logo">
        <img width="150px" src="{{ asset('assets/img/ahava.png') }}" alt="">
    </div>
    <div id="promo" >
        <h3>Febrero</h3>
        <p>Estamos estrenando página!</p>
        <p>Por ello <span>-20%</span> en tus invitaciones digitales</p>
        <img src="{{ asset('assets/img/stock/celu.png') }}" alt="">
    </div>
    <div>
    ...
    <div class="menu" onclick="this.classList.toggle('open')">
        <div class="button">
            <img width="30px" src="{{ asset('assets/img/icons/letter.png') }}" alt="">
        </div>
        <div class="button">
            <img width="30px" src="{{ asset('assets/img/icons/plant.png') }}" alt="">
        </div>
